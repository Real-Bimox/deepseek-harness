...
flowchart LR
  ...
  pkg_comfy["comfy"]
  svc_comfy["ctx.comfy<br/>ComfyUI API-v2 client"]
  pkg_tool_comfy["tool-comfy"]
  pkg_web["web"]
...
| `ctx.comfy` | `seam` | [`comfy`](../packages/comfy/comfy) | [`comfy`](../packages/comfy/comfy) | [`tool-comfy`](../packages/comfy/tool-comfy) | - | 单一 HTTP 客户端持有 Comfy API v2 作业与资产操作以及 ComfyUI 服务器发现；tool-comfy 将该能力呈现给模型。 |
